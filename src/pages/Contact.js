...
<div className="container content-center items-center justify-center min-w-full px-3">
    ...
    <form method="post" action="/contact">
        <div className="mb-3">
            ...
            <input type="text" className="form-control w-full font-spacemono block p-3 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="name" name="name" placeholder="John Doe" />
            {/* <div id="emailHelp" className="form-text">we'll never share your email with anyone else.</div> */}
          </div>
        <div className="mb-3">
          <label for="email" className="form-label px-3 font-spacemono">email address</label><br />
          <input type="email" className="form-control font-spacemono w-full block p-3 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="email" name="email" aria-describedby="emailHelp" placeholder="abc@example.com" />
        ...
        <div className="mb-3">
            ...
            <input type="number" className="form-control px-3 font-spacemono w-full block p-3 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="phone" name="phone" placeholder="+91 XXXXXXXXXX" />
        </div>
        <div className="mb-3">
          
<label for="message" className="block font-medium text-white font-spacemono px-3">your message</label>
